<template>
  <div class="pt-32">
    <div>
      ...
      <img
        class="w-24 mx-auto"
        src="https://gbstatic.djyde.com/sign_square_white.png?x-oss-process=style/80"
      />
    </div>
    <nav>
      <div class="flex flex-col sm:flex-row w-full justify-center p-8">
        <div :key="navItem.title" v-for="navItem in $themeConfig.navs" :class="['mt-6 sm:ml-6 sm:mr-6 text-gray-600', { 'text-gray-900': activeNav === navItem.alias }]">
